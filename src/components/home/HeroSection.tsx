 ...
 * el mouse. Los cartelitos orbitales (EN VIVO / ARGENTINA / 234K / MÚSICA /
...
export default function HeroSection() {
   ...
   * Los cartelitos (EN VIVO / ARGENTINA / 234K / MÚSICA / CAFECITOS / COMUNIDAD)
        ...
        <div className="hero-inner">
          <div className="hero-top">
            <div className="t-mono" style={{ color: 'var(--muted)' }}>
              Edición IA · 234K IG · Buenos Aires
            </div>
            <div className="t-mono" style={{ color: 'var(--muted)' }}>
              {clock}
            </div>
