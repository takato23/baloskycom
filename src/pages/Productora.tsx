...
const packages = [
  ...
  },
  {
    ...
    featured: true,
    pitch:
      'Hago la pieza con mi estética y la publico en mi cuenta: 234K seguidores, picos de 5.5M de views. Tu marca adentro del contenido que la gente ya quiere ver, no interrumpiéndolo.',
    includes: [
      ...
      <section className="prod-hero" id="productora">
        ...
        <div className="prod-hero__content" data-reveal>
          ...
          <ul className="prod-cred" aria-label="Datos de respaldo">
            <li><strong>234K</strong><span>seguidores · cuenta verificada</span></li>
